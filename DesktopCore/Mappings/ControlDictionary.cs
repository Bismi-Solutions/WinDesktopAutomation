...
using BismiSolutions.DesktopCore.UIItems.PropertyGridItems;
...
using BismiSolutions.DesktopCore.UIItems.TreeItems;
using BismiSolutions.DesktopCore.UIItems.WindowItems;
using BismiSolutions.DesktopCore.UIItems.WindowStripControls;
